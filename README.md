...
The college visit and open-house planner: a sortable/filterable table of 34 schools with an inline map (`index.html`), and a sourced profile page per school (`schools/`). Open `index.html` in a browser to view it — no server required.
...
- UC Berkeley virtual information session — September 3, 2026, 6:00–7:00 PM ET
- Princeton University virtual visit — September 4, 2026, 9:30–10:30 AM ET
