...
enrollment:
  value: ~46,600 undergraduates (Columbus/main campus, Autumn 2025); new first-year class of 8,210
  source: Ohio State News (official)
  url: https://news.osu.edu/ohio-state-enrollment-data-highlights-success-at-all-levels-of-student-population/
  checked: '2026-08-23'
studentFacultyRatio:
  value: '14:1'
  ...
  checked: '2026-08-23'
tuition:
  value: 'In-state: $13,641/yr (2025-26, incoming Ohio freshmen, locked via Tuition Guarantee); Out-of-state: $40,022/yr.'
  source: Ohio State News (official)
  url: https://news.osu.edu/ohio-state-sets-tuition-and-fees-for-the-2025-2026-academic-year/
  checked: '2026-08-23'
admissionRate:
  value: ~60.5% overall (Class of 2029); out-of-state reportedly ~35-40%
  source: NextGenAdmit (secondary)
  url: https://nextgenadmit.com/ohio-state-admission-statistics/
  checked: '2026-08-23'
retentionRate:
  value: 93.5-94% first-year retention
  source: Ohio State News (official)
  url: https://news.osu.edu/ohio-state-enrollment-data-highlights-success-at-all-levels-of-student-population/
  checked: '2026-08-23'
graduationRate:
  value: 72% four-year; 88% six-year
  source: U.S. News-derived (secondary)
  url: https://www.usnews.com/best-colleges/ohio-state-6883
  checked: '2026-08-23'
rankingOverall:
  rank: '#41 National Universities; #15 Top Public Schools'
...
BS in Mathematics with 6 tracks: Theoretical, Math for Educators, Financial Math, Biomath, Applied Math, Honors Math.

Source: [Ohio State College of Arts and Sciences](https://artsandsciences.osu.edu/academics/programs/majors/mathematics-bs) · checked 2026-08-23
Note: Whether a BA option also exists wasn't confirmed; only a BS was found.

## Theater program

Type: minor

Theatre Minor (15 credits, 2000-level+) and a separate Musical Theatre Minor, designed as a cognate for non-majors.
